...
class R2Image {
 public:
  ...
  //helper
  double gaussian(int row, int col, double sigma, int n);
  double dist(int x, int y);
  int getXGaussian(int col, int n);
  int getYGaussian(int row, int n);
  vector < vector <double> > gaussian_filter(int n, double sigma);
